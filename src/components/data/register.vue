<template>
        ...
        <div class="row justify-content-center">
          <div class="col-sm-12 col-md-8 col-lg-6">
            <div class="card">
              ...
              <div class="card-body">
                <form novalidate @submit.prevent="resgiterUser" >
                  ...
                  <div class="form-group">
                    <input type="password" :class="`form-control ${errors.password2 ?'is-invalid':''} `" 
                    placeholder="Comfirm Password" v-model="password2">
  ...
  <script>
  import validateRegisterInput from "../../js/validateRegisterInput";
  export default {
    data() {
      return{
        username:"",
